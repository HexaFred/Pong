...
public class Window extends JFrame implements Runnable {
    ...
    public Window(){
        ...
        leftScoreText = new Text(0, new Font("Times New Roman",Font.PLAIN,Constants.TEXT_SIZE), Constants.TEXT_X_POSE ,Constants.TEXT_Y_POSE);
        rightScoreText = new Text(0,
                new Font("Times New Roman",Font.PLAIN,Constants.TEXT_SIZE),
                Constants.SCREEN_WIDTH - Constants.TEXT_X_POSE - Constants.TEXT_SIZE ,Constants.TEXT_Y_POSE);
